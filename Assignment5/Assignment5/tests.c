...
void addTests(CuSuite* suite)
{
	...
	printf("SUITE_ADD_TEST(suite, testAdjustHeap) finished\n");
    SUITE_ADD_TEST(suite, testBuildHeap);
	printf("SUITE_ADD_TEST(suite, testBuildHeap)\n");
    SUITE_ADD_TEST(suite, testDyHeapAdd);
	printf("SUITE_ADD_TEST(suite, testDyHeapAdd);\n");
    SUITE_ADD_TEST(suite, testDyHeapRemoveMin);
	printf("SUITE_ADD_TEST(suite, testDyHeapRemoveMin);\n");
    SUITE_ADD_TEST(suite, testDyHeapGetMin);
	printf("SUITE_ADD_TEST(suite, testDyHeapGetMin);\n");
    SUITE_ADD_TEST(suite, testDyHeapSort);
	printf("SUITE_ADD_TEST(suite, testDyHeapSort);\n");
    SUITE_ADD_TEST(suite, testTaskNew);
	printf("SUITE_ADD_TEST(suite, testTaskNew);\n");
    SUITE_ADD_TEST(suite, testTaskCompare);
	printf("SUITE_ADD_TEST(suite, testTaskCompare);\n");
...
void runTests()
{
	...
	printf("suite = CuSuiteNew() finished\n");
    CuString* output = CuStringNew();
	printf("output = CuSuiteNew() finished\n");
    addTests(suite);
	printf("addTests(suite);\n");
    CuSuiteRun(suite);
	printf("CuSuiteRun(suite);\n");
    CuSuiteSummary(suite, output);
	printf("CuSuiteSummary(suite, output);\n");
    CuSuiteDetails(suite, output);
	printf("CuSuiteDetails(suite, output);\n");
    printf("%s\n", output->buffer);
    CuSuiteDelete(suite);
